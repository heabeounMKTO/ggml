...
model_state_dict = torch.load("/media/hbdesk/hb_desk_ext/weapons_classifier/weapon_classifier.pth",
                              map_location=torch.device("cpu"))
output_stream = open("/media/hbdesk/hb_desk_ext/weapons_classifier/weapon_classifier.bin", "wb")
